...
function search() {
    TweetJs.Search("(#ES_F OR #CL_F OR #WTI OR #NQ_F OR #RTY_F OR #YM_F OR #stoxx OR #spx OR #spy OR #Futures OR #VIX OR #NDX OR #Hedgefunds OR #daytrading OR #$DJI OR #$DIA OR #DJI OR #DIA OR #stockmarket OR #swingtrading OR #technicalanalysis) lang:en",
        function (data) {
            console.log(data);
